...
# Inferenza
# ============================================================
def run_inference(model, samples, img_dir, device, batch_size=32):
...
def evaluate_on_coco_val(model, val_samples, device,
                         results_path='/kaggle/working/coco_val_pred.json'):
...
def evaluate_on_ochuman(model, device, ann_file=OCHUMAN_VAL_ANN, img_dir=OCHUMAN_IMG,
                        results_path='/kaggle/working/ochuman_pred.json'):
