...
#
# TARATURA: SEVERITY_ALPHA centralizzato in config.py (con gli altri iperparametri).
#   0.0 -> hinge originale (retrocompatibile, per ablation)
#   2.0 -> modello finale sev_E7
...
def soft_argmax(heatmaps, beta=STL_BETA):
    ...
    beta (STL_BETA=50): temperatura softmax. Con sigma=2 e beta=50
    il gap mediano e' 0.27 px (p95=3.2 px). Valori bassi (~10) danno
    imprecisione sistematica; valori >100 causano gradienti troppo piccoli.
    """
